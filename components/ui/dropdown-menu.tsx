    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            "z-50 max-h-(--available-height) w-(--anchor-width) min-w-36 origin-(--transform-origin) overflow-x-hidden overflow-y-auto outline-none",
            "p-1 rounded-xl",
...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        "group/dropdown-menu-item relative flex cursor-pointer items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm outline-hidden select-none",
